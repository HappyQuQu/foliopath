...
func TestOpenAPIDeclaresRepositoryLicenseAndFrozenBaseline(t *testing.T) {
	...
	for _, required := range []string{
		...
		"targetVersion: POST-MVP-5",
		"scopeRevision: 2",
		"baselineEvent: CR-2026-021",
	} {
...
func TestOpenAPIHasExactAuthoritativeResourceOperations(t *testing.T) {
	...
	want := []string{
		...
		"POST /api/v1/ai/model-candidate-scans",
		"POST /api/v1/ai/model-candidates/{candidateId}/install",
		"POST /api/v1/ai/models/{modelId}/activate",
		"POST /api/v1/ai/operations/{operationId}/cancel",
		"GET /api/v1/libraries/{libraryId}/ai/semantic",
		"PATCH /api/v1/libraries/{libraryId}/ai/semantic",
		"POST /api/v1/libraries/{libraryId}/ai/semantic/jobs",
		"POST /api/v1/libraries/{libraryId}/ai/semantic/clear",
		"GET /api/v1/semantic/assets",
		"GET /api/v1/ai/tag-vocabulary",
		"PUT /api/v1/ai/tag-vocabulary",
		"GET /api/v1/libraries/{libraryId}/ai/tag-suggestions",
		"POST /api/v1/ai/tag-suggestion-reviews",
		"POST /api/v1/libraries/{libraryId}/ai/tag-suggestions/jobs",
		"POST /api/v1/libraries/{libraryId}/ai/tag-suggestion-reviews/clear",
		"GET /api/v1/semantic/videos",
		"POST /api/v1/libraries/{libraryId}/ai/video-semantic/jobs",
		"GET /api/v1/libraries/{libraryId}/ai/faces",
		"PATCH /api/v1/libraries/{libraryId}/ai/faces",
		"POST /api/v1/libraries/{libraryId}/ai/faces/jobs",
		"POST /api/v1/libraries/{libraryId}/ai/faces/derived-clear",
		"POST /api/v1/libraries/{libraryId}/ai/faces/manual-clear",
		"GET /api/v1/libraries/{libraryId}/ai/face-clusters",
		"GET /api/v1/libraries/{libraryId}/ai/face-clusters/{clusterId}",
		"GET /api/v1/people",
		"POST /api/v1/people",
		"GET /api/v1/people/{personId}",
		"GET /api/v1/people/{personId}/assets",
		"PATCH /api/v1/people/{personId}",
		"DELETE /api/v1/people/{personId}",
		"POST /api/v1/ai/face-reviews",
		"POST /api/v1/ai/face-reviews/{reviewId}/undo",
		"GET /api/v1/assets/{assetId}",
		"GET /api/v1/assets/{assetId}/faces",
