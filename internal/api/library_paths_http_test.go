		...
		list: func(
			...
			return library.PathPage{
				...
				Items: []library.PathEntry{
					...
					{
						Name:          "existing",
						RelativePath:  "家庭/existing",
						Selectable:    false,
						BlockedReason: library.SelectionBlockedOverlapping,
						ConflictID:    12,
						ConflictName:  "现有媒体库",
					},
				},
	...
	assertJSONEquals(t, response, map[string]any{
		...
		"items": []any{
			...
			map[string]any{
				...
				"hasChildren":            false,
				"selectable":             false,
				"selectionBlockedReason": "overlapping_library",
				"conflictingLibraryId":   "lib_12",
				"conflictingLibraryName": "现有媒体库",
			},
		},
		"nextCursor": "next-opaque-cursor",
	})
