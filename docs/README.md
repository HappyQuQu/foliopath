...
- [UIF-401～408 当前集成状态](releases/MVP-2026-07-23-uif-integration-status.md)：
  聚合逐页比较、Linux 基线、真实纵向链、浏览器/可访问性、100k/10k 容量、完整仓库验证和
  文档收敛、四档逐页比较和受影响 Stage 5 复验；`UIF-S4` 已 Go，MVP RC 仍 No-Go。
- [UIF-S4 Integrated Slice Done](gates/MVP-2026-07-23/uif-s4-integrated-slice-done.md)：
  `UIF-AC-001～012` 实际证据已接受；不解除最终 digest、物理辅助功能或供应链阻断。
