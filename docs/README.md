...
| 判断能否开工 | [开发就绪评审](development-readiness.md) | [媒体库 Backend Ready](gates/MVP-2026-07-23/s2-library-backend-ready.md)、[扫描 Contract Ready](gates/MVP-2026-07-23/s2-scan-contract-ready.md)、[Stage 2 Architecture Ready](gates/MVP-2026-07-23/stage-2-architecture-ready.md)、[认证 Backend Ready](gates/MVP-2026-07-23/s1-auth-backend-ready.md)、[Stage 0 Gate](gates/MVP-2026-07-23/stage-0-current.md)、[可行性研究](feasibility-study.md)、[FS-01～05](spikes/fs-05-runtime-recovery.md)、[风险登记](risk-register.md) |
