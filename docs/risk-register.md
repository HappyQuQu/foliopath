...
| R-013 | 多媒体库共享任务队列时出现饥饿或请求被后台工作拖慢 | 中 | 高 | 一个大库占满 worker；API 延迟随扫描显著上升 | [S2-102](gates/MVP-2026-07-23/s2-bounded-scan-worker.md) 与 [S2-106](gates/MVP-2026-07-23/s2-scan-capacity.md) 固定扫描 2-worker 公平队列；[S3-005](gates/MVP-2026-07-23/s3-media-jobs-cache.md) 固定媒体 2-worker/3-attempt 跨库公平，[S3-006](gates/MVP-2026-07-23/s3-media-resource-safety.md) 进一步固定 govips concurrency 1 和 FFmpeg 单 decoder/filter thread。正式 HTTP catalog 延迟由 S3-007/Performance Gate 验证 | 暂停/限速后台任务，改为手动扫描模式 | 技术负责人 | 缓解中 |
