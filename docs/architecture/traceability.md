...
| `FR-AUTH-005`、`FR-UI-009` 管理中心独立功能页与账户维护 | `MVP-2026-07-23` | Frozen r3；交互原型完成；生产 Contract/Gate Pending | [CR-2026-006](../changes/CR-2026-006-management-center-pages.md) | `internal/auth` 拥有当前密码验证、密码哈希与其他会话撤销；`internal/settings` 拥有受控偏好；既有 library/scanner/thumbnail capability 保持规则所有权；`web` settings routes 只通过生成 client/adapter 组合 | 独立 general/libraries/storage/account 路由；账户资料/密码 operation 计划；既有媒体库、扫描、缓存 operation 复用 | 单管理员显示名称/密码哈希/会话；settings revision；原型 local state 不进入生产 import graph | ADR-0005、ADR-0007；[用户流程第 8 节](../user-flows.md)；[界面设计](../ui-design.md) | R-010、R-012、R-015、R-016 | 当前只有四页可操作原型与浏览器交互证据；生产仍需 OpenAPI、当前密码/Unicode/确认/撤销会话安全测试、ETag 冲突、生成 client、键盘/axe、四档响应式和 Stage 5 三引擎回归，未通过前不得标记 Integrated Done | 账户回到 1 Contract Ready；设置复用 2 并新增 UI Gate；5 重验 |
...
| `FR-UI-001～007` 界面与可访问性 | `MVP-2026-07-23` | Frozen r1；[S4-005 搜索预览 Done](../gates/MVP-2026-07-23/s4-frontend-search-preview.md)；[S4-006 Viewer Done](../gates/MVP-2026-07-23/s4-frontend-media-viewer.md)；[S4-007 Media Strategy Done](../gates/MVP-2026-07-23/s4-frontend-media-strategy.md)；[S4-008 Media Matrix Done](../gates/MVP-2026-07-23/s4-frontend-media-matrix.md)；[Stage 4 Integrated Done](../gates/MVP-2026-07-23/s4-search-media-integrated-done.md) | [CR-2026-001](../changes/CR-2026-001-non-modal-media-preview.md)；[CR-2026-003](../changes/CR-2026-003-brand-identity.md)；[redesign 应用壳恢复](../changes/FIX-2026-07-29-redesign-shell-restoration.md)；[原型品牌对齐](../changes/FIX-2026-07-30-prototype-brand-alignment.md) | `web` 的 auth/libraries/browse/search/media/settings feature；统一 API client；共享 `BrandMark`、`MediaCollection`、`MediaPreview`、`MediaViewer`、`MediaAvailabilityState` 与 `useMediaPreviewController` | 欢迎/认证、设置、扫描状态、浏览/搜索/预览/查看器；统一品牌入口；桌面固定侧栏和底部上下文导航、移动抽屉、中英与主题 | 服务端状态不复制为独立事实；URL 保存导航状态，`settings` 保存受控偏好；固定预览保存当前媒体快照，查看器瞬时状态只保存已载入 ID 序列和安全返回位置；品牌 SVG 是无业务状态的静态资产 | [ADR-0001](../adr/0001-go-react-sqlite.md)、[ADR-0007](../adr/0007-shared-frontend-system.md)、[用户流程](../user-flows.md)、[界面设计](../ui-design.md)、[品牌标识](../branding.md) | R-005、R-010、R-015、R-016 | loading/empty/error/offline/cancel、预览选择/固定/双击、搜索刷新不中断固定媒体、查看器缩放/平移/信息/全屏/关闭恢复、媒体离线/缺失/不可读/损坏/不支持/删除、固定侧栏/底部导航/顶栏/工具栏与 Apple redesign 同视口截图对照、统一目录树品牌 SVG 与原型同视口对照、键盘/触摸/焦点/读屏、主题/语言/reduced-motion、响应式、虚拟化、关键 E2E | 1（认证 UI/品牌原语）、3、4（Integrated Done）；5（发布浏览器/真机加固） |
...
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；UIF-S0/S1 Go；S2 Pending | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、reference manifest、Linux-owned visual regression | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计 | R-015、R-016、R-021 | [FTR-UIF-001](../features/frontend-prototype-fidelity.md) 的 `UIF-AC-009～010`；`UIF-301～408` 完成后回填 comparison、三浏览器、axe、键盘、触摸与 Stage 5 重验 | `UIF-S0～S4`、5 |
