...
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S3 Consumer/UI Ready](../gates/MVP-2026-07-23/uif-s3-consumer-ui-ready.md) Go；Phase 3 `UIF-301～318` 与 Phase 4 `UIF-401` 完成 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、机器校验 reference manifest、Linux-owned visual regression | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计 | R-015、R-016、R-021 | 12 个生产页面已绑定原型、路由、状态和确定性 fixture；[`UIF-401 evidence`](../evidence/uif-401/README.md)保存同一 `1280 × 720` CSS 视口下的逐页原型/真实生产路由组合比较与 history；认证卡片和 Browse 同状态 fixture 的可见差异已关闭。既有 `zh-CN/en × light/dark × 390/768/1265/1440`、overflow/axe/reduced-motion、键盘/触摸、六种浏览器/输入 profile 和三引擎 100k 有界 DOM 继续通过。Phase 4 仍需扩展 Linux-owned 视觉回归、完整纵向链和候选复验 | `UIF-S0～S3 Done → S4 UIF-402～408 → Stage 5` |
