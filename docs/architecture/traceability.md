...
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S3 Consumer/UI Ready](../gates/MVP-2026-07-23/uif-s3-consumer-ui-ready.md) Go；Phase 3 `UIF-301～318` 与 Phase 4 `UIF-401～405` 完成 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、机器校验 reference manifest、Linux-owned visual regression、真实浏览器纵向链 | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计；真实链不修改原媒体 | R-015、R-016、R-021 | 12 个生产页面已绑定原型、路由、状态和确定性 fixture；[`UIF-401 evidence`](../evidence/uif-401/README.md)保存同一 `1280 × 720` CSS 视口下的逐页原型/真实生产路由组合比较与 history；[`UIF-402 evidence`](../evidence/uif-402/README.md)固定 11 张 Linux 基线并无更新复跑 `9 passed`；[`UIF-403 evidence`](../evidence/uif-403/README.md)完成真实纵向链并验证媒体路径/SHA-256 不变；[`UIF-404 evidence`](../evidence/uif-404/README.md)完成三引擎与可访问性适用复验；[`UIF-405 evidence`](../evidence/uif-405/README.md)完成三引擎 100k 滚动/DOM/FPS/RSS 与后端 10k/100k 扫描期并发复验。Phase 4 仍需完整验证、文档同步和最终 Gate | `UIF-S0～S3 Done → S4 UIF-406～408 → Stage 5` |
