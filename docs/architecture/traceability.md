...
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；UIF-S0/S1/S2 Go；Phase 3 `UIF-301～317` 完成 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、reference manifest、Linux-owned visual regression | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计 | R-015、R-016、R-021 | 通用设置、共享管理壳、Browse、Viewer 与八类状态已保存同视口比较；UIF-317 又完成 `zh-CN/en × light/dark × 390/768/1265/1440` 工作台截图和真实设置页 overflow/axe/reduced-motion 矩阵。UIF-318 尚需签署 Consumer/UI Ready；Phase 4 仍需逐页 comparison、扩展视觉回归、完整纵向链和容量复验 | `UIF-S0～S2 Done → S3 UIF-318 → S4 → Stage 5` |
