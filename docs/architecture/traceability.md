...
| `FR-SCN-001～009` 扫描与索引 | `MVP-2026-07-23` | Frozen r1；[Contract Ready](../gates/MVP-2026-07-23/s2-scan-contract-ready.md)；[S2-102 worker](../gates/MVP-2026-07-23/s2-bounded-scan-worker.md) | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/jobs` 拥有领取/租约/worker；`internal/scanner` 拥有 generation；`internal/files` 与 SQLite adapter | 创建/启动/定时/手动扫描、历史/详情轮询、协作取消、错误和跳过统计 | `scan_runs`、`scan_issues`、`directories`、`assets`、generation、typed schedule；同库唯一 full scan 与 durable admission | [ADR-0003](../adr/0003-scan-consistency.md)、[数据模型](../data-model.md) | R-003、R-004、R-005、R-013、R-016 | S2-101 已冻结契约，S2-004 已实施 creation/manual admission；S2-102 已实现容量 1 wake、2 个全局 worker、公平 claim、15/120 秒 heartbeat/lease、三次恢复、真实 creation scan composition 与架构检查。Backend Gate 仍须由 S2-103～107 证明完整目录/计数、fingerprint/stale cleanup、故障/重启、磁盘/I/O/WAL 与容量 | 2（S2-101～102 已完成；当前 S2-103）；容量证据在 0/FS-04 |
