...
| `FR-AUTH-005`、`FR-UI-009` 管理中心独立功能页与账户维护 | `MVP-2026-07-23` | Frozen r3；UIF-S2 Backend Evidence Ready；UIF-406 repository verification passed | [CR-2026-006](../changes/CR-2026-006-management-center-pages.md) | `internal/auth` 拥有当前密码验证、密码哈希与其他会话撤销；`internal/settings` 拥有受控偏好；既有 library/scanner/thumbnail capability 保持规则所有权；`web` settings routes 只通过生成 client/adapter 组合 | 独立 general/libraries/storage/account 路由；账户资料/密码；媒体库、扫描、缓存 operation 复用 | 单管理员显示名称/密码哈希/会话；settings revision；原型 local state 不进入生产 import graph | ADR-0005、ADR-0007；[用户流程第 8 节](../user-flows.md)；[界面设计](../ui-design.md)；[UIF-403 evidence](../evidence/uif-403/README.md)；[UIF-404 evidence](../evidence/uif-404/README.md)；[UIF-405 evidence](../evidence/uif-405/README.md)；[UIF-406 evidence](../evidence/uif-406/README.md) | R-010、R-012、R-015、R-016 | OpenAPI、账户安全事务、ETag、生成 client 与后端矩阵已由 UIF-S2 通过；UIF-403 真实纵向链、UIF-404 三引擎/可访问性自动化适用项、UIF-405 100k/10k 容量与并发、UIF-406 完整仓库验证均通过。物理辅助功能和 Stage 5 仍待重验 | `UIF-S0～S3 Done → S4 UIF-407～408 → Stage 5` |
| `FR-BRW-010`、`FR-UI-010`、`NFR-UIF-001` 生产前端原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S0](../gates/MVP-2026-07-23/uif-s0-architecture-ready.md) Go；[UIF-S1](../gates/MVP-2026-07-23/uif-s1-contract-ready.md) Go；[UIF-S2](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md) Go；UIF-406 repository verification passed | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | `internal/auth` 账户维护；`internal/catalog` 目录 q/cursor；`internal/thumbnail` 缓存摘要/清理；SQLite/API adapter；`web` 唯一 token、壳、媒体集合和预览 owner | account profile/password；direct-directory q；cache summary/cleanup；全局 Header、BrowseShell、ManagementShell、Search 无侧栏、四档视觉 Gate | migration 13 已实现 users revision、directory search key、singleton cleanup state，并复用 sessions/idempotency/cache；视觉 reference 不进入生产 import graph | [FTR-UIF-001](../features/frontend-prototype-fidelity.md)；[开发清单](../features/frontend-prototype-fidelity-task-list.md)；[目录 spike](../spikes/uif-001-directory-filter.md)；[UIF-S2 evidence](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md)；[UIF-403 evidence](../evidence/uif-403/README.md)；[UIF-404 evidence](../evidence/uif-404/README.md)；[UIF-405 evidence](../evidence/uif-405/README.md)；[UIF-406 evidence](../evidence/uif-406/README.md)；ADR-0005/0007；无需新 ADR | R-010、R-012、R-015、R-016、R-021 | 真实容器纵向链、三引擎/可访问性自动化适用复验、三引擎 100k 滚动/DOM/RSS、后端 10k/100k 扫描期并发均通过；fmt、architecture、generation、lint、unit、integration 和生产容器 E2E 七项完整验证通过；S4 仍需文档同步与 Stage 5 重验 | `UIF-S0～S3 Done → S4 UIF-407～408 → Stage 5` |
...
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S3 Consumer/UI Ready](../gates/MVP-2026-07-23/uif-s3-consumer-ui-ready.md) Go；Phase 3 `UIF-301～318` 与 Phase 4 `UIF-401～406` 完成 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、机器校验 reference manifest、Linux-owned visual regression、真实浏览器纵向链 | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计；真实链不修改原媒体 | R-015、R-016、R-021 | 12 个生产页面已绑定原型、路由、状态和确定性 fixture；[`UIF-401 evidence`](../evidence/uif-401/README.md)完成逐页同视口原型比较；[`UIF-402 evidence`](../evidence/uif-402/README.md)固定 11 张 Linux 基线；[`UIF-403 evidence`](../evidence/uif-403/README.md)完成真实纵向链并验证媒体不变；[`UIF-404 evidence`](../evidence/uif-404/README.md)完成三引擎与可访问性适用复验；[`UIF-405 evidence`](../evidence/uif-405/README.md)完成 100k/10k 容量与并发复验；[`UIF-406 evidence`](../evidence/uif-406/README.md)完成七项完整仓库验证。Phase 4 仍需文档同步和最终 Gate | `UIF-S0～S3 Done → S4 UIF-407～408 → Stage 5` |
