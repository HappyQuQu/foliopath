...
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；UIF-S0/S1/S2 Go；Phase 3 逐页接入 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、reference manifest、Linux-owned visual regression | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计 | R-015、R-016、R-021 | 通用设置与共享管理壳已保存 [1440/390 对照](../../design-qa.md)并关闭该页 P0/P1/P2；`UIF-301～408` 其余页面仍需 comparison、三浏览器、axe、键盘、触摸与 Stage 5 重验 | `UIF-S0～S2 Done → S3 → S4 → Stage 5` |
