...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `FR-DEP-001～004` 部署与设置 | `MVP-2026-07-23` | Frozen r1；[S5-001A 发布镜像基础](../gates/MVP-2026-07-23/s5-release-image-foundation.md)；[S5-001B/001C/002 候选矩阵](../gates/MVP-2026-07-23/s5-compose-candidate-matrix.md)；[S5-004A 恢复演练](../gates/MVP-2026-07-23/s5-recovery-failure-smoke.md) | `BASELINE-2026-07-23` | `internal/app`、`internal/api`、`internal/webassets`、`internal/store/sqlite`；根 `Dockerfile`、`compose.yaml` 与容器适配器 | 启动/初始化、嵌入 SPA、`/health/live`、`/health/ready`、`/api/v1/status`、设置读写 | migrations、`settings`、运行版本与健康状态；Vite 产物仅在构建期嵌入 | [ADR-0001](../adr/0001-go-react-sqlite.md)、[ADR-0009](../adr/0009-linux-openat2-single-media-root.md)、[架构](../architecture.md)、[部署](../deployment.md) | R-002、R-004、R-008、R-011、R-014、R-016 | 候选镜像已在本机原生 linux/arm64 与操作者指定的原生 linux/amd64 验证嵌入 SPA、固定非 root、只读根/媒体、health、SIGTERM、MVP 媒体、Compose/代理、恢复、强杀/WAL、盘满/损坏失败关闭，以及不同不可变候选间向前升级和配对回滚。CI 同 commit/run JSON 契约保留但本轮不等待 Billing 阻断；最终 digest/provenance 仍由 S5-001/007 阻断 | 1、5 |
...
| `FR-AUTH-005`、`FR-UI-009` 管理中心独立功能页与账户维护 | `MVP-2026-07-23` | Frozen r3；UIF-S2 Backend Evidence Ready；UIF-404 automated applicability passed | [CR-2026-006](../changes/CR-2026-006-management-center-pages.md) | `internal/auth` 拥有当前密码验证、密码哈希与其他会话撤销；`internal/settings` 拥有受控偏好；既有 library/scanner/thumbnail capability 保持规则所有权；`web` settings routes 只通过生成 client/adapter 组合 | 独立 general/libraries/storage/account 路由；账户资料/密码；媒体库、扫描、缓存 operation 复用 | 单管理员显示名称/密码哈希/会话；settings revision；原型 local state 不进入生产 import graph | ADR-0005、ADR-0007；[用户流程第 8 节](../user-flows.md)；[界面设计](../ui-design.md)；[UIF-403 evidence](../evidence/uif-403/README.md)；[UIF-404 evidence](../evidence/uif-404/README.md) | R-010、R-012、R-015、R-016 | OpenAPI、账户安全事务、ETag、生成 client 与后端矩阵已由 UIF-S2 通过；生产四个独立路由和真实 account/cache/settings adapter 已接入；UIF-403 以真实后端完成资料改名、改密、设置、cache cleanup、退出和新密码重登；UIF-404 的三引擎、axe、键盘、触摸、forced-colors 与 reduced-motion 自动化适用项通过。物理辅助功能和 Stage 5 仍待重验 | `UIF-S0～S3 Done → S4 UIF-405～408 → Stage 5` |
| `FR-BRW-010`、`FR-UI-010`、`NFR-UIF-001` 生产前端原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S0](../gates/MVP-2026-07-23/uif-s0-architecture-ready.md) Go；[UIF-S1](../gates/MVP-2026-07-23/uif-s1-contract-ready.md) Go；[UIF-S2](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md) Go；UIF-404 automated applicability passed | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | `internal/auth` 账户维护；`internal/catalog` 目录 q/cursor；`internal/thumbnail` 缓存摘要/清理；SQLite/API adapter；`web` 唯一 token、壳、媒体集合和预览 owner | account profile/password；direct-directory q；cache summary/cleanup；全局 Header、BrowseShell、ManagementShell、Search 无侧栏、四档视觉 Gate | migration 13 已实现 users revision、directory search key、singleton cleanup state，并复用 sessions/idempotency/cache；视觉 reference 不进入生产 import graph | [FTR-UIF-001](../features/frontend-prototype-fidelity.md)；[开发清单](../features/frontend-prototype-fidelity-task-list.md)；[目录 spike](../spikes/uif-001-directory-filter.md)；[UIF-S2 evidence](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md)；[UIF-403 evidence](../evidence/uif-403/README.md)；[UIF-404 evidence](../evidence/uif-404/README.md)；ADR-0005/0007；无需新 ADR | R-010、R-012、R-015、R-016、R-021 | OpenAPI/生成 client/合同兼容、账户事务/安全、目录 10k P95、100k 有界缓存清理、12→13 integrity/restart、cachefs 原媒体边界和完整仓库检查均通过；真实容器纵向链已覆盖账户、目录 q、cache cleanup、logout/login，并验证媒体路径/SHA-256 不变；三引擎、axe、键盘、触摸、forced-colors 和 reduced-motion 自动化适用复验通过；S4 仍需容量与最终 Stage 5 重验 | `UIF-S0～S3 Done → S4 UIF-405～408 → Stage 5` |
...
| `FR-SCN-010～014` 媒体库自动发现 | `POST-MVP-2` | Frozen r2；WCH-S0 Go；[WCH-S1 Contract Ready](../gates/POST-MVP-2/wch-s1-contract-ready.md) Go；[WCH-S2 Backend Evidence Ready](../gates/POST-MVP-2/wch-s2-backend-evidence-ready.md)发布 No-Go、有限授权 S3 本地 UI | [CR-2026-005](../changes/CR-2026-005-automatic-library-discovery.md) | `internal/scanner` 拥有事件合并、定向范围、清理资格和 content revision；`internal/files` 实现 Linux watch/安全重开；`internal/jobs` durable lease；SQLite/API adapter；Web 统一 query-key 刷新 owner | 自动发现设置/状态；新增、修改、删除、rename 的定向校准；浏览/搜索刷新按钮与目录导航重取；不轮询、不推送 | migration 12 专用 `catalog_reconcile_jobs` requested/claimed 水位；library/global `content_revision`；settings 开关；完整扫描/定向任务按库互斥 | [FTR-SCN-001](../features/automatic-library-discovery.md)；ADR-0003/0009；[ADR-0011](../adr/0011-linux-inotify-hints-and-anchored-reconciliation.md)已接受 | R-002、R-003、R-005、R-013、R-016、R-019 | 后端 Linux/arm64 证据矩阵已完成；revision 2 UI 已实现浏览/搜索刷新、目录导航重取和 cursor 首页面裁剪测试。S2 发布仍需原生 amd64 | `WCH-S0 Done → S1 Done → S2 release No-Go / S3 local authorized → S4` |
| `FR-OPS-001～006`、`NFR-OPS-002` 后台任务中心 | `POST-MVP-3` | Scope Proposed；S0 Pending；生产合同与实现 Blocked | [CR-2026-008](../changes/CR-2026-008-task-center.md) | 候选 `internal/operations` 只拥有跨 capability task 投影、公共 task ID、filter/cursor 与 action dispatch；`internal/scanner` 拥有 scan；`internal/thumbnail` 拥有 derived run；`internal/jobs` 拥有 lease/claim/fairness/retry；SQLite/API/Web adapter | 高层任务列表/详情；scan cancel/retry；missing/all derived batch；不暴露逐资产队列 | 现有 `scan_runs`/`media_jobs`；候选只追加 `operation_runs`，精确 migration 与公共 ID 由 S1 冻结 | [FTR-OPS-001](../features/task-center.md)；[开发清单](../features/task-center-task-list.md)；复用 ADR-0001/0006/0007/0009；若改变任务一致性或边界则新增 ADR | R-003、R-006、R-009、R-011、R-013、R-015、R-016、R-020 | 只有可操作原型、需求与后端任务拆分；现有 scan 合同可复用，derived parent run、聚合 API、migration、容量和恢复证据均未实现 | `OPS-S0 Pending → S1 → S2 → S3 → S4` |
| `FR-UI-001～007` 界面与可访问性 | `MVP-2026-07-23` | Frozen r1；[S4-005 搜索预览 Done](../gates/MVP-2026-07-23/s4-frontend-search-preview.md)；[S4-006 Viewer Done](../gates/MVP-2026-07-23/s4-frontend-media-viewer.md)；[S4-007 Media Strategy Done](../gates/MVP-2026-07-23/s4-frontend-media-strategy.md)；[S4-008 Media Matrix Done](../gates/MVP-2026-07-23/s4-frontend-media-matrix.md)；[Stage 4 Integrated Done](../gates/MVP-2026-07-23/s4-search-media-integrated-done.md) | [CR-2026-001](../changes/CR-2026-001-non-modal-media-preview.md)；[CR-2026-003](../changes/CR-2026-003-brand-identity.md)；[redesign 应用壳恢复](../changes/FIX-2026-07-29-redesign-shell-restoration.md)；[原型品牌对齐](../changes/FIX-2026-07-30-prototype-brand-alignment.md) | `web` 的 auth/libraries/browse/search/media/settings feature；统一 API client；共享 `BrandMark`、`AsyncState`、`InlineStatus`、`FormField`、`Button`、`Toast`、`MediaCollection`、`MediaPreview`、`MediaViewer`、`MediaAvailabilityState` 与 `useMediaPreviewController` | 欢迎/认证、设置、扫描状态、浏览/搜索/预览/查看器；统一品牌入口；桌面固定侧栏和底部上下文导航、移动抽屉、中英与主题；UIF-316 八类状态工作台矩阵；UIF-317 locale/theme/四档/input 矩阵 | 服务端状态不复制为独立事实；URL 保存导航状态，`settings` 保存受控偏好；固定预览保存当前媒体快照，查看器瞬时状态只保存已载入 ID 序列和安全返回位置；品牌 SVG 是无业务状态的静态资产 | [ADR-0001](../adr/0001-go-react-sqlite.md)、[ADR-0007](../adr/0007-shared-frontend-system.md)、[用户流程](../user-flows.md)、[界面设计](../ui-design.md)、[品牌标识](../branding.md) | R-005、R-010、R-015、R-016 | loading/empty/offline/error/conflict/cancel/pending/success 由唯一共享组件语义和真实领域状态覆盖；工作台接入真实 locale/provider 和主题 token，并保存 2×2×4 确定性视觉矩阵；真实设置页笛卡尔 E2E 检查 lang/theme/overflow/axe/reduced-motion，既有纵向链和媒体矩阵覆盖键盘焦点返回、Pixel 5 触摸、三引擎与 forced-colors；其余证据包括预览/查看器、媒体降级、原型同视口对照、虚拟化和关键 E2E | 1（认证 UI/品牌原语）、3、4（Integrated Done）；5（发布浏览器/真机加固） |
...
| `NFR-REL-002`、`NFR-PERF-003` watcher 一致性与资源边界 | `POST-MVP-2` | Frozen r2；WCH-S0/S1 Go；S2 发布 No-Go；S3 Conditional Go | [CR-2026-005](../changes/CR-2026-005-automatic-library-discovery.md) | scanner 定向校准与 content revision、files Linux watcher、jobs/SQLite durable admission、Web 有界显式刷新 | 事件不是清理资格；丢失/重复/乱序/overflow 后完整扫描收敛；每目录 watch 和所有队列/刷新有界；无 catalog revision 轮询 | ADR-0003/0009/0011；R-003、R-005、R-013、R-019 | WCH-001 已验证 Linux/arm64 10k watch 与真实 overflow；生产实现固定 32,768 watch、8,192 event、4,096 dirty、2 global/1 per-library 并发，通过 Linux/arm64 纵向链、全应用回归、100k 进程内 burst 有界 overflow、dirty 硬上限、双 worker 跨库 claim、跨 SQLite 重开与独立领取进程强杀恢复、受控内核 ENOSPC 回滚和真实 nested mount/unmount 恢复；四核/4 GiB 的 100k/10k 档进一步覆盖 10,001 watch 注册且进程 FD 不按目录增长、100 个跨目录增量发布、P95 与进程写调用预算；S3 覆盖显式刷新、目录返回重取和 cursor 首页面裁剪。S2 发布仍需原生 amd64 | `WCH-S0～S4` |
| `NFR-PERF-001～002` 资源与容量 | `MVP-2026-07-23` | Frozen r1；[S5-005 候选容量](../gates/MVP-2026-07-23/s5-release-capacity-candidate.md)；[S5-005C 原生 amd64 真实媒体](../gates/MVP-2026-07-23/s5-native-amd64-real-media.md)；[S5-005D 原生 amd64 目标容量](../gates/MVP-2026-07-23/s5-native-amd64-capacity.md) | `BASELINE-2026-07-23` | 有界队列/并发、串行批量写、keyset、虚拟化、缓存水位、全局工作调度 | 四核/4 GiB、约 10 万媒体/1 万目录为主验收档；扫描时浏览仍可用，发布预算由代表性设备 Gate 固定 | ADR-0001、ADR-0003；R-005、R-009、R-013、R-015 | [FS-04](../spikes/fs-04-capacity-baseline.md)、[S2-106](../gates/MVP-2026-07-23/s2-scan-capacity.md)、[S4-003](../gates/MVP-2026-07-23/s4-search-backend-ready.md)和[S3-107](../gates/MVP-2026-07-23/s3-frontend-capacity.md)已固定扫描、搜索与前端有界 DOM。S5-005 在本机 arm64 与指定原生 amd64 通过 100k/10k 扫描、认证查询、重扫、取消/offline、100k 全量派生、cache 90%→80% 水位、持续健康和三引擎 FPS/RSS，并关闭 session、unchanged 派生与 cache 淘汰写放大 | 0/FS-04、2～5（S5-005 Passed） |
| `NFR-ACC-001` 可访问性 | `MVP-2026-07-23` | Frozen r1；[S5-006A 浏览器质量候选](../gates/MVP-2026-07-23/s5-browser-quality-candidate.md)；[UIF-404 automated applicability](../evidence/uif-404/README.md) passed | `BASELINE-2026-07-23` | 语义 HTML、DOM 顺序、焦点管理、状态文案、主题与 reduced-motion token | 核心流程键盘可完成，状态不只依赖颜色，目标 WCAG 2.2 AA | UI 设计；R-015、R-016 | Chromium/Firefox/WebKit 共同验证查看器焦点、键盘、降级状态、overflow 与 axe serious/critical；移动 Chromium touch、Chrome 151 forced-colors 和 storyboard reduced-motion 通过。axe/模拟输入不冒充物理签署；最终真实 Firefox、读屏、200%/400% 缩放、OS 高对比和代表性触摸/移动设备仍由 S5-006B 阻断 | 1、3、4、5 |
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S3 Consumer/UI Ready](../gates/MVP-2026-07-23/uif-s3-consumer-ui-ready.md) Go；Phase 3 `UIF-301～318` 与 Phase 4 `UIF-401～404` 完成 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、机器校验 reference manifest、Linux-owned visual regression、真实浏览器纵向链 | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计；真实链不修改原媒体 | R-015、R-016、R-021 | 12 个生产页面已绑定原型、路由、状态和确定性 fixture；[`UIF-401 evidence`](../evidence/uif-401/README.md)保存同一 `1280 × 720` CSS 视口下的逐页原型/真实生产路由组合比较与 history；[`UIF-402 evidence`](../evidence/uif-402/README.md)固定 11 张 Linux 基线并无更新复跑 `9 passed`；[`UIF-403 evidence`](../evidence/uif-403/README.md)以真实容器完成 setup/login、账户、建库/扫描、目录 q、搜索、预览/Viewer、设置/cache cleanup、logout/login，并让媒体路径和 SHA-256 前后完全一致；[`UIF-404 evidence`](../evidence/uif-404/README.md)完成三引擎、axe、键盘、触摸、forced-colors、reduced-motion 与物理适用边界复验。Phase 4 仍需容量和最终复验 | `UIF-S0～S3 Done → S4 UIF-405～408 → Stage 5` |
| `NFR-COMP-001` 平台兼容 | `MVP-2026-07-23` | Frozen r1；[S5-006A 浏览器质量候选](../gates/MVP-2026-07-23/s5-browser-quality-candidate.md)；[S5-007A 候选供应链](../gates/MVP-2026-07-23/s5-supply-chain-candidate.md)；[S5-007C 最小媒体运行时](../gates/MVP-2026-07-23/s5-minimal-media-runtime.md)；[S5-007D 最小 FFmpeg 运行时](../gates/MVP-2026-07-23/s5-minimal-ffmpeg-runtime.md)；[S5-007E 内建健康检查](../gates/MVP-2026-07-23/s5-built-in-healthcheck-runtime.md)；[S5-007F 无 shell 最小运行时](../gates/MVP-2026-07-23/s5-distroless-runtime.md)；[S5-008 发布文档](../gates/MVP-2026-07-23/s5-release-documentation.md) | `BASELINE-2026-07-23` | Debian-family 构建层、distroless final stage、Go/CGO、最小 libvips/FFmpeg、内建健康检查、浏览器兼容层 | 承诺的 linux/amd64、linux/arm64 和主流浏览器行为必须由同一 fixture 验证 | ADR-0001；R-007、R-008、R-014、R-017 | FS-03 与 S5-002 双架构媒体/runtime 已通过；S5-006A 已把 Chromium/Firefox/WebKit 稳定状态和 Linux 视觉回归接入 CI，Safari 26.5.2 真机链及 Chrome 150 normal/forced-colors 已通过；候选已建立确定性 SPDX、双架构扫描/notices 和 provenance 入口，固定源码 Expat 2.8.2 把结果降至 1 Critical / 8 High。最终 digest、全阻断风险决定、真实 Firefox/读屏/缩放/触摸与移动设备签署仍待 Gate | 0/FS-03/05、5 |
