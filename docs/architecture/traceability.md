...
| `FR-SRH-001～004` 搜索过滤排序 | `MVP-2026-07-23` | Frozen r1；[S4-001 Contract Ready](../gates/MVP-2026-07-23/s4-search-contract-ready.md)；[S4-002 Implemented](../gates/MVP-2026-07-23/s4-search-keyset.md) | `BASELINE-2026-07-23` | `internal/catalog` 拥有 search profile、scope、排序与 cursor；SQLite FTS adapter；`web` search feature | 当前目录（可递归）/当前库/全部库搜索，类型和 filesystem mtime 半开区间过滤，结果查看/返回 | migration 10 的 `assets.search_*_key`、外部内容 FTS5 `asset_search`、`catalog_search_state.revision`；库内 generation 与跨库 revision cursor | [ADR-0001](../adr/0001-go-react-sqlite.md)、[数据模型](../data-model.md)、[S4 搜索契约](../api-design.md#s4-搜索契约) | R-005、R-012、R-016 | S4-002 已实现 NFKC/full fold、trigram candidate + 精确字面 AND、短词/标点 fallback、三种 scope、kind/mtime、稳定 name/mtime keyset、offline、认证 HTTP、旧库回填与 composition，并由 Unicode/范围/cursor/cancel fixture 验证；S4-003 仍须完成 100k、扫描并发、重建/取消扩展矩阵和 Backend Ready 汇总 | 4（Implemented；当前 S4-003，尚未 Backend Ready） |
