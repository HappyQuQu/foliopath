...
| `FR-SCN-001～009` 扫描与索引 | `MVP-2026-07-23` | Frozen r1；[Contract Ready](../gates/MVP-2026-07-23/s2-scan-contract-ready.md)；[S2-102 worker](../gates/MVP-2026-07-23/s2-bounded-scan-worker.md)；[S2-103 目录计数](../gates/MVP-2026-07-23/s2-directory-counts.md) | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/jobs` 拥有领取/租约/worker；`internal/scanner` 拥有 generation/目录策略；`internal/files` 与 SQLite adapter | 创建/启动/定时/手动扫描、历史/详情轮询、协作取消、错误和跳过统计 | `scan_runs`、`scan_issues`、`directories`、`assets`、generation、typed schedule；同库唯一 full scan 与 durable admission | [ADR-0003](../adr/0003-scan-consistency.md)、[数据模型](../data-model.md) | R-003、R-004、R-005、R-013、R-016 | S2-101 已冻结契约；S2-102 已完成有界 worker/lease/recovery；S2-103 已验证 production creation scan 索引根、空/隐藏/嵌套目录，以 O(D) 有界叶批次原子发布直接/递归计数，并在失败或拓扑损坏时保留可靠代次。Backend Gate 仍须由 S2-104～107 证明 fingerprint/stale 收敛、故障/重启、磁盘/I/O/WAL 与容量 | 2（S2-101～103 已完成；当前 S2-104）；容量证据在 0/FS-04 |
