...
| `FR-CUR-001～007`、`NFR-CUR-001～003` 收藏与手动标签 | `POST-MVP-4` revision 1 | Scope Frozen；[CUR-S3 Consumer UI Ready](../gates/POST-MVP-4/cur-s3-consumer-ui-ready.md) Go；[CUR-S4](../gates/POST-MVP-4/cur-s4-integrated-slice-current.md) Conditional Go | [CR-2026-020](../changes/CR-2026-020-favorites-and-tags.md) | `internal/curation` 规范化、状态、revision、cursor；SQLite/API adapter；`web/src/features/curation` consumer | 收藏切换/列表；标签词表、单资产替换和标签媒体页；全部/单库范围 | migration 21 `curation_state`、`asset_favorites`、`tags`、`asset_tags`；复合 FK cascade、ETag 与稳定 keyset | [FTR-CUR-001](../features/favorites-and-tags.md)；复用 ADR-0001/0006/0007 | R-005、R-012、R-015、R-016、R-023 | Unicode/幂等/precondition/cursor/cascade、OpenAPI/generated client、HTTP/CSRF、真实 composition、原媒体不变、TS/前端行为/Storybook 证据通过；Docker E2E、依赖 advisory 与目标浏览器签署待解除 | `CUR-S0 Done → S1 Done → S2 Go → S3 Go → S4 Conditional Go` |
| `FR-INT-001～020`、`NFR-INT-001～010` 本地智能媒体发现 | `POST-MVP-5` 提案 | Scope 未冻结；[INT-S0](../gates/POST-MVP-5/int-s0-architecture-ready.md) No-Go | [CR-2026-021](../changes/CR-2026-021-intelligent-media-discovery.md) | 提议 `internal/semantic`、`internal/face`、`internal/aimodel`、capability-owned inference port、SQLite/向量 adapter；`internal/app` 组合；AI 标签仍经 curation owner | 图片/视频语义、受控标签建议、匿名人脸聚类与人工人物库；审核源下载、固定 `/models:ro` 扫描、托管复制/直接读取和兼容模型选择 | 数据模型草案见技术架构；embedding/cluster 可重建，people/manual assignment/exclusion 为应用状态；model operation 可清理；尚无 migration/API | [FTR-INT-001](../features/intelligent-media-discovery.md)；[技术架构](intelligent-media-discovery.md)；[ADR-0013](../adr/0013-local-ai-runtime-and-derived-vector-index.md)提议 | R-024～R-030 | [INT-001](../spikes/int-001-ai-feasibility.md) 未执行；模型/许可/双架构/100k/聚类/隐私/下载与离线获取全部 Pending | `Proposal → S0 No-Go；只允许文档、原型与隔离 spike` |
