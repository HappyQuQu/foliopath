...
| `FR-AUTH-005`、`FR-UI-009` 管理中心独立功能页与账户维护 | `MVP-2026-07-23` | Frozen r3；UIF-S2 Backend Evidence Ready；生产 UI 接入中 | [CR-2026-006](../changes/CR-2026-006-management-center-pages.md) | `internal/auth` 拥有当前密码验证、密码哈希与其他会话撤销；`internal/settings` 拥有受控偏好；既有 library/scanner/thumbnail capability 保持规则所有权；`web` settings routes 只通过生成 client/adapter 组合 | 独立 general/libraries/storage/account 路由；账户资料/密码；媒体库、扫描、缓存 operation 复用 | 单管理员显示名称/密码哈希/会话；settings revision；原型 local state 不进入生产 import graph | ADR-0005、ADR-0007；[用户流程第 8 节](../user-flows.md)；[界面设计](../ui-design.md) | R-010、R-012、R-015、R-016 | OpenAPI、账户安全事务、ETag、生成 client 与后端矩阵已由 UIF-S2 通过；生产四个独立路由和真实 account/cache/settings adapter 已接入，通用页与共享管理壳有 1440/390 对照。仍需其余页面四档、axe、三引擎、真实纵向链及 Stage 5 重验 | `UIF-S0～S2 Done → S3 → S4 → Stage 5` |
| `FR-BRW-010`、`FR-UI-010`、`NFR-UIF-001` 生产前端原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S0](../gates/MVP-2026-07-23/uif-s0-architecture-ready.md) Go；[UIF-S1](../gates/MVP-2026-07-23/uif-s1-contract-ready.md) Go；[UIF-S2](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md) Go | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | `internal/auth` 账户维护；`internal/catalog` 目录 q/cursor；`internal/thumbnail` 缓存摘要/清理；SQLite/API adapter；`web` 唯一 token、壳、媒体集合和预览 owner | account profile/password；direct-directory q；cache summary/cleanup；全局 Header、BrowseShell、ManagementShell、Search 无侧栏、四档视觉 Gate | migration 13 已实现 users revision、directory search key、singleton cleanup state，并复用 sessions/idempotency/cache；视觉 reference 不进入生产 import graph | [FTR-UIF-001](../features/frontend-prototype-fidelity.md)；[开发清单](../features/frontend-prototype-fidelity-task-list.md)；[目录 spike](../spikes/uif-001-directory-filter.md)；[UIF-S2 evidence](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md)；ADR-0005/0007；无需新 ADR | R-010、R-012、R-015、R-016、R-021 | OpenAPI/生成 client/合同兼容、账户事务/安全、目录 10k P95、100k 有界缓存清理、12→13 integrity/restart、cachefs 原媒体边界和完整仓库检查均通过；S3/S4 仍需四档同视口、三浏览器/axe/键盘/触摸、真实纵向 E2E 和 Stage 5 重验 | `UIF-S0～S2 Done → S3 → S4 → Stage 5` |
...
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S3 Consumer/UI Ready](../gates/MVP-2026-07-23/uif-s3-consumer-ui-ready.md) Go；Phase 3 `UIF-301～318` 与 Phase 4 `UIF-401～402` 完成 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、机器校验 reference manifest、Linux-owned visual regression | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计 | R-015、R-016、R-021 | 12 个生产页面已绑定原型、路由、状态和确定性 fixture；[`UIF-401 evidence`](../evidence/uif-401/README.md)保存同一 `1280 × 720` CSS 视口下的逐页原型/真实生产路由组合比较与 history；[`UIF-402 evidence`](../evidence/uif-402/README.md)固定 Header、管理四页、Browse 顶部/底部/预览、Search、可用/离线 Viewer 的 11 张 Linux 基线，并在生成后无更新复跑 `9 passed`。既有 `zh-CN/en × light/dark × 390/768/1265/1440`、overflow/axe/reduced-motion、键盘/触摸、六种浏览器/输入 profile 和三引擎 100k 有界 DOM 继续通过。Phase 4 仍需完整纵向链和候选复验 | `UIF-S0～S3 Done → S4 UIF-403～408 → Stage 5` |
