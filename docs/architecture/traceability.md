...
| `FR-INT-001～020`、`NFR-INT-001～010` 本地智能媒体发现 | `POST-MVP-5` r2 | Frozen r2；S2A/S2B/S2C Backend Ready；[INT-S3 Consumer/UI Ready](../gates/POST-MVP-5/int-s3-consumer-ui-ready.md) / Release No-Go | [CR-2026-021](../changes/CR-2026-021-intelligent-media-discovery.md)；[CR-2026-022](../changes/CR-2026-022-s2-backend-release-gate-separation.md)；[CR-2026-023](../changes/CR-2026-023-s3-offline-model-ui-contract-alignment.md)；ADR-0014/0015 | 后端：`internal/semantic`、`internal/aimodel`、`internal/face` 与 inference/media/SQLite/API/app adapters；消费者：`web/src/features/ai`、`web/src/features/search`；共享媒体集合/预览/查看器 | 离线模型管理、图片/视频语义搜索、标签审核、匿名组/人物/逐脸人工复核；禁止身份推断、自动标签、云/GPU/新部署单元 | migrations 22～35；生成客户端；URL/query key；浏览器只保留偏好、瞬时选择和 opaque operation ID | revision 2 scope；A+B/C+D+E capability；model package；`api/openapi.yaml`；data/security/deployment/testing；ADR-0013/0014/0015 | R-024～R-030 全部适用且开放 | S3 真实 API 消费、中英文隐私文案、键盘等价人脸列表、revision/CSRF/idempotency、Storybook/axe 配置与四断点矩阵完成；S4 仍缺最终模型、governed quality、native paired image、联合容量、供应链与发布签署 | `Frozen r2 A～E → S2 Backend Ready → S3 Consumer/UI Ready / Release No-Go → S4 blocked` |
