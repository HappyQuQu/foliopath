...
| `FR-LIB-001～008` 媒体库管理 | `MVP-2026-07-23` | Frozen r1 | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/library`；`internal/files` 和 SQLite adapter | 允许目录选择、媒体库创建/列表/详情/改名/移除、离线重试 | `libraries`；所有关联记录以 `library_id` 作用域；根路径创建后不可变；创建与 durable 首次扫描请求一致提交；SQL 由 adapter 内 sqlc query 源生成 | [ADR-0001](../adr/0001-go-react-sqlite.md)、[ADR-0002](../adr/0002-library-path-model.md)、[ADR-0004](../adr/0004-library-root-immutable.md)、[ADR-0009](../adr/0009-linux-openat2-single-media-root.md)、[安全模型](../security.md) | R-002、R-003、R-012、R-016 | Architecture Ready 已列正常/边界/失败/恢复矩阵；Contract Ready 仍须固定 HTTP/数据/事务/错误；Backend Gate 须补生产 handler/认证错误边界、离线/根替换、幂等创建、移除后原文件逐字节不变；只读发布 volume 与运行期 unmount 留在 Release Gate | 2（S2-001～007） |
