...
| `FR-SCN-001～009` 扫描与索引 | `MVP-2026-07-23` | Frozen r1 | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/scanner`、`internal/jobs`；`internal/files` 与 SQLite adapter | 创建/启动/定时/手动扫描、历史/详情轮询、协作取消、错误和跳过统计 | `scan_runs`、`directories`、`assets`、`media_jobs`、generation、聚合计数、扫描设置；同库唯一 full scan 与 durable admission | [ADR-0003](../adr/0003-scan-consistency.md)、[数据模型](../data-model.md) | R-003、R-004、R-005、R-013、R-016 | Architecture Ready 已固定 owner、交接和故障/恢复场景；Contract Ready 仍须固定状态、幂等、取消、schedule、资源上限与 migration；Backend Gate 须证明分批提交、失败/取消/中断/离线不清理、成功 finalize、跨库公平、重启、磁盘/I/O/WAL 与生产 scanner 容量 | 2（S2-101～107）；容量证据在 0/FS-04 |
