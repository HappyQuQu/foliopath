...
| `FR-AUTH-005`、`FR-UI-009` 管理中心独立功能页与账户维护 | `MVP-2026-07-23` | Frozen r3；UIF-S2 Backend Evidence Ready；UIF-403 real vertical chain passed | [CR-2026-006](../changes/CR-2026-006-management-center-pages.md) | `internal/auth` 拥有当前密码验证、密码哈希与其他会话撤销；`internal/settings` 拥有受控偏好；既有 library/scanner/thumbnail capability 保持规则所有权；`web` settings routes 只通过生成 client/adapter 组合 | 独立 general/libraries/storage/account 路由；账户资料/密码；媒体库、扫描、缓存 operation 复用 | 单管理员显示名称/密码哈希/会话；settings revision；原型 local state 不进入生产 import graph | ADR-0005、ADR-0007；[用户流程第 8 节](../user-flows.md)；[界面设计](../ui-design.md)；[UIF-403 evidence](../evidence/uif-403/README.md) | R-010、R-012、R-015、R-016 | OpenAPI、账户安全事务、ETag、生成 client 与后端矩阵已由 UIF-S2 通过；生产四个独立路由和真实 account/cache/settings adapter 已接入；UIF-403 又以真实后端完成资料改名、改密、设置、cache cleanup、退出和新密码重登。仍需候选浏览器/可访问性与 Stage 5 重验 | `UIF-S0～S3 Done → S4 UIF-404～408 → Stage 5` |
| `FR-BRW-010`、`FR-UI-010`、`NFR-UIF-001` 生产前端原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S0](../gates/MVP-2026-07-23/uif-s0-architecture-ready.md) Go；[UIF-S1](../gates/MVP-2026-07-23/uif-s1-contract-ready.md) Go；[UIF-S2](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md) Go；UIF-403 real vertical chain passed | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | `internal/auth` 账户维护；`internal/catalog` 目录 q/cursor；`internal/thumbnail` 缓存摘要/清理；SQLite/API adapter；`web` 唯一 token、壳、媒体集合和预览 owner | account profile/password；direct-directory q；cache summary/cleanup；全局 Header、BrowseShell、ManagementShell、Search 无侧栏、四档视觉 Gate | migration 13 已实现 users revision、directory search key、singleton cleanup state，并复用 sessions/idempotency/cache；视觉 reference 不进入生产 import graph | [FTR-UIF-001](../features/frontend-prototype-fidelity.md)；[开发清单](../features/frontend-prototype-fidelity-task-list.md)；[目录 spike](../spikes/uif-001-directory-filter.md)；[UIF-S2 evidence](../gates/MVP-2026-07-23/uif-s2-backend-evidence-ready.md)；[UIF-403 evidence](../evidence/uif-403/README.md)；ADR-0005/0007；无需新 ADR | R-010、R-012、R-015、R-016、R-021 | OpenAPI/生成 client/合同兼容、账户事务/安全、目录 10k P95、100k 有界缓存清理、12→13 integrity/restart、cachefs 原媒体边界和完整仓库检查均通过；真实容器纵向链已覆盖账户、目录 q、cache cleanup、logout/login，并验证媒体路径/SHA-256 不变；S4 仍需候选浏览器/可访问性、容量与 Stage 5 重验 | `UIF-S0～S3 Done → S4 UIF-404～408 → Stage 5` |
...
| `NFR-ACC-001` 可访问性 | `MVP-2026-07-23` | Frozen r1；[S5-006A 浏览器质量候选](../gates/MVP-2026-07-23/s5-browser-quality-candidate.md) | `BASELINE-2026-07-23` | 语义 HTML、DOM 顺序、焦点管理、状态文案、主题与 reduced-motion token | 核心流程键盘可完成，状态不只依赖颜色，目标 WCAG 2.2 AA | UI 设计；R-015、R-016 | Chromium/Firefox/WebKit 已共同验证查看器焦点、键盘、降级状态、overflow 与 axe serious/critical；固定 Linux 深色/reduced-motion 视觉基线已独立复跑。最终版本、Safari 真机、读屏、缩放和 forced-colors 仍由 S5-006B 阻断 | 1、3、4、5 |
| `NFR-UIF-001` 生产页面原型一致性 | `MVP-2026-07-23` | Frozen r4；[UIF-S3 Consumer/UI Ready](../gates/MVP-2026-07-23/uif-s3-consumer-ui-ready.md) Go；Phase 3 `UIF-301～318` 与 Phase 4 `UIF-401～403` 完成 | [CR-2026-009](../changes/CR-2026-009-frontend-prototype-fidelity.md) | 中央 token、共享壳、机器校验 reference manifest、Linux-owned visual regression、真实浏览器纵向链 | 四档同状态比较无 P0/P1/P2；主要区域几何偏差不超过 2px；基线更新可审计；真实链不修改原媒体 | R-015、R-016、R-021 | 12 个生产页面已绑定原型、路由、状态和确定性 fixture；[`UIF-401 evidence`](../evidence/uif-401/README.md)保存同一 `1280 × 720` CSS 视口下的逐页原型/真实生产路由组合比较与 history；[`UIF-402 evidence`](../evidence/uif-402/README.md)固定 11 张 Linux 基线并无更新复跑 `9 passed`；[`UIF-403 evidence`](../evidence/uif-403/README.md)以真实容器完成 setup/login、账户、建库/扫描、目录 q、搜索、预览/Viewer、设置/cache cleanup、logout/login，并让媒体路径和 SHA-256 前后完全一致。Phase 4 仍需候选浏览器/可访问性、容量和最终复验 | `UIF-S0～S3 Done → S4 UIF-404～408 → Stage 5` |
