...
| `FR-LIB-001～008` 媒体库管理 | `MVP-2026-07-23` | Frozen r1；[Contract Ready](../gates/MVP-2026-07-23/s2-library-contract-ready.md)；[S2-004 implemented](../gates/MVP-2026-07-23/s2-library-lifecycle-implemented.md)；[S2-005 safety matrix](../gates/MVP-2026-07-23/s2-library-safety-matrix.md)；[S2-006 removal invariance](../gates/MVP-2026-07-23/s2-library-removal-invariance.md) | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/library`；`internal/files` 和 SQLite adapter | 允许目录选择、媒体库创建/列表/详情/改名/移除、离线重试 | `libraries.revision`、`name_sort_key`、唯一 creation scan、`library_removals`、摘要化 `idempotency_records`；根不可变；创建三记录同事务 | [ADR-0001](../adr/0001-go-react-sqlite.md)、[ADR-0002](../adr/0002-library-path-model.md)、[ADR-0004](../adr/0004-library-root-immutable.md)、[ADR-0009](../adr/0009-linux-openat2-single-media-root.md)、[安全模型](../security.md) | R-002、R-003、R-012、R-016 | S2-002～006 已覆盖安全目录选择、媒体库生命周期与完整路径故障矩阵；真实认证删除链路证明只清理 SQLite/`/app/data` 派生状态，完整媒体树逐字节不变，bounded cleanup 可跨重启续作。Backend Gate 只剩 S2-007 最终审计；发布 volume/unmount 留在 Release Gate | 2（S2-001～006 已完成；S2-007） |
| `FR-SCN-001～009` 扫描与索引 | `MVP-2026-07-23` | Frozen r1；[Contract Ready](../gates/MVP-2026-07-23/s2-scan-contract-ready.md) | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/scanner`、`internal/jobs`；`internal/files` 与 SQLite adapter | 创建/启动/定时/手动扫描、历史/详情轮询、协作取消、错误和跳过统计 | `scan_runs`、`scan_issues`、`directories`、`assets`、generation、typed schedule；同库唯一 full scan 与 durable admission | [ADR-0003](../adr/0003-scan-consistency.md)、[数据模型](../data-model.md) | R-003、R-004、R-005、R-013、R-016 | S2-101 已冻结完整扫描契约；S2-004 已实施 creation/manual durable admission、同库 coalesce、256 active 上限、active removal 拒绝和有界 wake signal。Backend Gate 仍须由 S2-102～107 证明 worker 领取/租约/恢复、分批提交、失败/取消/中断/离线不清理、成功 finalize、跨库公平、重启、磁盘/I/O/WAL 与容量 | 2（S2-101 与 S2-004 admission handoff 已完成；S2-102～107）；容量证据在 0/FS-04 |
