...
| `FR-LIB-001～008` 媒体库管理 | `MVP-2026-07-23` | Frozen r1；[Contract Ready](../gates/MVP-2026-07-23/s2-library-contract-ready.md) | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/library`；`internal/files` 和 SQLite adapter | 允许目录选择、媒体库创建/列表/详情/改名/移除、离线重试 | `libraries.revision`、唯一 creation scan、`library_removals`、摘要化 `idempotency_records`；根不可变；创建三记录同事务；SQL 由 adapter 内 sqlc query 源生成 | [ADR-0001](../adr/0001-go-react-sqlite.md)、[ADR-0002](../adr/0002-library-path-model.md)、[ADR-0004](../adr/0004-library-root-immutable.md)、[ADR-0009](../adr/0009-linux-openat2-single-media-root.md)、[安全模型](../security.md) | R-002、R-003、R-012、R-016 | OpenAPI/SQLite 契约已冻结；S2-002 已完成认证 handler → library use case → files anchored adapter、流式直接子目录枚举、自然 keyset 分页、opaque query-bound cursor、真实 composition 与 symlink/mount/脱敏回归。S2-003 已集中 NFC/NFKC full-fold 名称规则、规范相对根、组件重叠和不可变根，并以同事务 SQLite 冲突检查、数据库约束、picker 冲突标注及跨 Store race 回归提供证据。Backend Gate 仍须补创建生命周期/离线/根替换/移除原文件不变；发布 volume/unmount 留在 Release Gate | 2（S2-001～003 已完成；S2-004～007） |
| `FR-SCN-001～009` 扫描与索引 | `MVP-2026-07-23` | Frozen r1；[Contract Ready](../gates/MVP-2026-07-23/s2-scan-contract-ready.md) | `BASELINE-2026-07-23`；[Stage 2 Architecture Ready](../gates/MVP-2026-07-23/stage-2-architecture-ready.md) | `internal/scanner`、`internal/jobs`；`internal/files` 与 SQLite adapter | 创建/启动/定时/手动扫描、历史/详情轮询、协作取消、错误和跳过统计 | `scan_runs`、`scan_issues`、`directories`、`assets`、generation、typed schedule；同库唯一 full scan 与 durable admission | [ADR-0003](../adr/0003-scan-consistency.md)、[数据模型](../data-model.md) | R-003、R-004、R-005、R-013、R-016 | S2-101 已冻结 durable admission/coalesce、phase/counters/有限 issues、条件轮询、协作取消、heartbeat/lease 三次恢复、默认 24 小时 typed schedule，以及 256 active/2 workers/256 batch 资源上限；version 4 migration 与 OpenAPI 契约测试提供证据。Backend Gate 仍须证明生产 worker 分批提交、失败/取消/中断/离线不清理、成功 finalize、跨库公平、重启、磁盘/I/O/WAL 与容量 | 2（S2-101 已完成；S2-102～107）；容量证据在 0/FS-04 |
