...
const zhCN = {
  ...
  "diagnostics.reason.missing_moov_atom": "MP4 缺少 moov 索引，文件可能未完整写入或已损坏",
...
const en: Record<MessageKey, string> = {
  ...
  "diagnostics.reason.missing_moov_atom": "The MP4 moov index is missing; the file may be incomplete or damaged",
  ...
  "about.viewRelease": "View full release notes",
